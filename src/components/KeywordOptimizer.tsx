  ...
  return (
    <div className="rounded-xl overflow-hidden border border-white/10">
      <div className="flex items-center justify-between px-3 py-1.5 bg-slate-900/80 border-b border-white/8">
        <span className="text-[10px] font-mono text-slate-400">HTML — 복사 후 &lt;head&gt;에 붙여넣기</span>
        <button
          onClick={copy}
          className="flex items-center gap-1 text-[11px] px-2 py-1 rounded-lg bg-white/8 hover:bg-white/15 text-slate-300 transition-all"
        >
