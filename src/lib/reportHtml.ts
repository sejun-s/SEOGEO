...
import { CONFIDENCE_LABEL, summarizeEvidence } from './readinessEvidence'
...
export function buildReportHtml(audit: AuditResult, options: { showToolbar?: boolean } = {}): string {
  ...
  const evidence = summarizeEvidence(audit.ruleResults ?? [], ['technical', 'schema', 'bing', 'chatgpt', 'geo', 'eeat', 'naver'])
...
.report{border-radius:18px}.cover{padding:52px 56px 42px;border-top:0;background:linear-gradient(135deg,#111b3b 0%,#1b2a55 100%);color:#fff}.cover small{color:#9db4ff;font-size:10px}.cover h1{font-size:32px;letter-spacing:-.035em}.cover p{color:#c7d1e8}.cover .meta{color:#9daac4;border-top:1px solid rgba(255,255,255,.12);padding-top:20px}.section{padding:38px 56px}.section h2{font-size:20px;letter-spacing:-.02em}.section h2:after{content:"";display:block;width:28px;height:3px;margin-top:10px;background:#3157d5;border-radius:9px}.hero-score,.summary-card{border-radius:12px;padding:22px}.hero-score b{font-size:46px}.methodology{display:grid;grid-template-columns:repeat(4,1fr);border:1px solid #dfe4ec;border-radius:12px;overflow:hidden}.methodology>div{padding:20px;border-right:1px solid #e4e8ef}.methodology>div:last-child{border:0}.methodology span,.methodology b,.methodology small{display:block}.methodology span{font-size:10px;color:#737d91;font-weight:700}.methodology b{font-size:15px;margin:8px 0 5px;color:#17213f}.methodology small{font-size:9px;color:#8992a4}.issue{grid-template-columns:42px 1fr;padding:30px 0}.issue-no{width:38px;height:38px;border-radius:10px}.issue-head>div small,.issue-head>div strong{display:block}.issue-head>div small{font-size:9px;color:#3157d5;letter-spacing:.12em;margin-bottom:5px}.issue-head strong{font-size:15px}.issue-head span{font-size:10px;font-weight:700}.finding-grid{display:grid;grid-template-columns:1fr 1fr;gap:12px;margin-top:16px}.finding-grid p{margin:0;padding:14px 16px;background:#f7f8fb;border:1px solid #e5e8ee;border-radius:9px}.action-box{margin-top:12px;padding:16px 18px;border-left:3px solid #3157d5;background:#f1f4ff;border-radius:0 9px 9px 0}.action-box>b,.code-label,.verification>b{font-size:10px;color:#3157d5;letter-spacing:.05em}.action-box p{margin:5px 0 0;color:#34405a}.code-label{margin:14px 0 6px}.verification{display:flex;align-items:center;gap:9px;margin-top:12px;font-size:9px;color:#6e788c}.verification span{flex:1}.verification a{color:#3157d5;text-decoration:none;font-weight:700}.note{font-size:10px;line-height:1.65}.footer{padding:28px 56px;font-size:10px}
